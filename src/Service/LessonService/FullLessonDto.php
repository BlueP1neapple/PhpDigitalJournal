...
final class FullLessonDto
{
     ...
     * @return string|null
     */
    public function getTeacherCabinet(): ?string
    {
     ...
     *
     * @param string|null $teacherCabinet
     */
    public function setTeacherCabinet(?string $teacherCabinet): void
    {
     ...
     *
     * @param string|null $classNumber
     */
    public function setClassNumber(?string $classNumber): void
    {
